                 ...
                 <%--        <div class="sidebar__item">   
                            ...
                            <ul>
                                <li <c:if test="${PSUBCATEGORY eq null}"> class="active" </c:if>>
                                	<a href="nlist.product?PCATEGORY=신상품">ALL</a></li>
                            ...
                            %>
                            	<div class="sidebar__item__price">
	                                <input type="button" name="lineUpPrice" value="전체 선택" 
	                                	...
	                                	location.href='nlist.product?PCATEGORY=신상품&PSUBCATEGORY=${PSUBCATEGORY}'">
	                            </div>
                            ...
                            <c:forEach var="i" begin="0" end="${fn:length(lineUpPrice_arr)-1}" step="1">
	                            <div class="sidebar__item__price">
	                                <input type="button" name="lineUpPrice" value="${lineUpPrice_arr[i]}" 
	                                	...
	                                	onClick="if(this.value) 
	                                	location.href='nlist.product?&lineUpPrice=${lineUpPrice_arr[i]}&PCATEGORY=신상품&PSUBCATEGORY=${PSUBCATEGORY}'">
	                            </div>
                            </c:forEach>                          
                        </div>
                ...
                <div class="col-lg-9 col-md-7">
                    <div class="product__discount">                   
                        ...
                        <div class="row">
                            ...
                            <!-- 총 5개 for문 돌리기 -->
                            <c:forEach var="nlists" items="${NewItem}" begin="0" end="4" step="1">
                                <div class="col-lg-4">
                                    <div class="product__discount__item">
                                        <div class="product__discount__item__pic set-bg">  
                                             
                                            <a href="pdetail.product?PNUM=${nlists.PNUM}">
                                            	<img src="img/product/product_img/${nlists.PSUBCATEGORY}/${nlists.PNAME}/${nlists.PIMG1}">
                                            </a>
                                         
                                            <div class="product__discount__percent">BEST</div>    
                                            <ul class="product__item__pic__hover">
                                                <li><a href="pdetail.product?PNUM=${nlists.PNUM}"><i class="fa fa-retweet"></i></a></li>
                                                <li><a onClick="cartPopup(${nlists.PNUM},'${nlists.PNAME}',1)"><i class="fa fa-shopping-cart"></i></a></li>
                                            </ul>
                                        </div>
                                        
                                        <div class="product__discount__item__text">
                                            <span>${nlists.PSUBCATEGORY}</span>
                                            <h5><a href="pdetail.product?PNUM=${nlists.PNUM}">${nlists.PNAME}</a></h5>
                                            <div class="product__item__price">
                                           		<fmt:formatNumber value="${nlists.PPRICE}" pattern="###,###"/> 원</div>
                                        </div>                                        
                                    </div>
                                </div>
                             </c:forEach>                                   
                            ...
                            <div class="col-lg-4 col-md-5">
                                <div class="filter__sort">
                                    ...
                                    <select onChange="if(this.value) location.href=(this.value);">
                                        <option value="nlist.product?PCATEGORY=신상품"
                                        	<c:if test="${fn:contains(lineUp, null)}"> selected </c:if> >추천순</option>
                                   <%--      <option value="nlist.product?PCATEGORY=신상품&lineUpPrice=${lineUpPrice}&lineUp=신상품순"
                                        	<c:if test="${fn:contains(lineUp, '신상품순')}"> selected </c:if> >신상품순</option> --%>
                                        <option value="nlist.product?PCATEGORY=신상품&lineUpPrice=${lineUpPrice}&lineUp=인기상품순"
                                        	<c:if test="${fn:contains(lineUp, '인기상품순')}"> selected </c:if> >인기상품순</option>
                                        <option value="nlist.product?PCATEGORY=신상품&lineUpPrice=${lineUpPrice}&lineUp=낮은가격순"
                                        	<c:if test="${fn:contains(lineUp, '낮은가격순')}"> selected </c:if> >낮은 가격순</option>
                                        <option value="nlist.product?PCATEGORY=신상품&lineUpPrice=${lineUpPrice}&lineUp=높은가격순"	
