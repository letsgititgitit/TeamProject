...
<form:form action="registerForm.me" method="post" commandName="memberBean" name="memberRegisterForm">
	<table align="center">
		<tr>
...
<%-- 		<tr>
		...
		<tr>
			<td colspan="3" align="center">
				<button type="submit" onClick="return check()" class="btn btn-primary btn-xl text-uppercase" style="background-color: #7fad39;border-color: #7fad39;width:350px;height:50px;margin-top: 25px;margin-right: 25px">가입하기</button>
			</td>
		</tr>
